...
PROTOBUF_CONSTEXPR PbfTrackerConfig::PbfTrackerConfig(
  ...
  , /*decltype(_impl_.existance_fusion_method_)*/{nullptr, ::_pbi::ConstantInitialized{}}} {}
...
const uint32_t TableStruct_modules_2fperception_2fproto_2fpbf_5ftracker_5fconfig_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::apollo::perception::fusion::PbfTrackerConfig, _impl_.existance_fusion_method_),
  0,
  1,
  2,
  3,
...
const ::PROTOBUF_NAMESPACE_ID::internal::LazyString PbfTrackerConfig::Impl_::_i_give_permission_to_break_this_code_default_existance_fusion_method_{{{"DstExistanceFusion", 18}}, {nullptr}};
...
PbfTrackerConfig::PbfTrackerConfig(const PbfTrackerConfig& from)
  ...
  new (&_impl_) Impl_{
    ...
    , decltype(_impl_.existance_fusion_method_){}};
  ...
  _impl_.existance_fusion_method_.InitDefault();
  if (from._internal_has_existance_fusion_method()) {
    _impl_.existance_fusion_method_.Set(from._internal_existance_fusion_method(), 
      GetArenaForAllocation());
  }
...
inline void PbfTrackerConfig::SharedDtor() {
  ...
  _impl_.existance_fusion_method_.Destroy();
}
    ...
    switch (tag >> 3) {
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 34)) {
          ...
          CHK_(ptr);
          #ifndef NDEBUG
          ::_pbi::VerifyUTF8(str, "apollo.perception.fusion.PbfTrackerConfig.existance_fusion_method");
          #endif  // !NDEBUG
        } else
          goto handle_unusual;
        continue;
...
// @@protoc_insertion_point(class_specific_merge_from_start:apollo.perception.fusion.PbfTrackerConfig)
  ...
  if (cached_has_bits & 0x0000000fu) {
    ...
    if (cached_has_bits & 0x00000008u) {
      _internal_set_existance_fusion_method(from._internal_existance_fusion_method());
    }
  }
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}
...
void PbfTrackerConfig::InternalSwap(PbfTrackerConfig* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &_impl_.existance_fusion_method_, lhs_arena,
      &other->_impl_.existance_fusion_method_, rhs_arena
  );
}
