...
class PbfTrackerConfig final :
 ...
 public:
  ...
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_existance_fusion_method(ArgT0&& arg0, ArgT... args);
  std::string* mutable_existance_fusion_method();
  PROTOBUF_NODISCARD std::string* release_existance_fusion_method();
  ...
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_existance_fusion_method(const std::string& value);
 ...
 private:
  ...
  struct Impl_ {
    ...
    static const ::PROTOBUF_NAMESPACE_ID::internal::LazyString _i_give_permission_to_break_this_code_default_existance_fusion_method_;
...
inline void PbfTrackerConfig::clear_existance_fusion_method() {
  _impl_.existance_fusion_method_.ClearToDefault(::apollo::perception::fusion::PbfTrackerConfig::Impl_::_i_give_permission_to_break_this_code_default_existance_fusion_method_, GetArenaForAllocation());
...
inline const std::string& PbfTrackerConfig::existance_fusion_method() const {
  ...
  if (_impl_.existance_fusion_method_.IsDefault()) return Impl_::_i_give_permission_to_break_this_code_default_existance_fusion_method_.get();
  return _internal_existance_fusion_method();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void PbfTrackerConfig::set_existance_fusion_method(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000008u;
 _impl_.existance_fusion_method_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline std::string* PbfTrackerConfig::mutable_existance_fusion_method() {
  std::string* _s = _internal_mutable_existance_fusion_method();
...
inline const std::string& PbfTrackerConfig::_internal_existance_fusion_method() const {
  return _impl_.existance_fusion_method_.Get();
}
inline void PbfTrackerConfig::_internal_set_existance_fusion_method(const std::string& value) {
  _impl_._has_bits_[0] |= 0x00000008u;
  _impl_.existance_fusion_method_.Set(value, GetArenaForAllocation());
}
inline std::string* PbfTrackerConfig::_internal_mutable_existance_fusion_method() {
  _impl_._has_bits_[0] |= 0x00000008u;
  return _impl_.existance_fusion_method_.Mutable(::apollo::perception::fusion::PbfTrackerConfig::Impl_::_i_give_permission_to_break_this_code_default_existance_fusion_method_, GetArenaForAllocation());
}
inline std::string* PbfTrackerConfig::release_existance_fusion_method() {
  ...
  _impl_._has_bits_[0] &= ~0x00000008u;
  auto* p = _impl_.existance_fusion_method_.Release();
  return p;
}
inline void PbfTrackerConfig::set_allocated_existance_fusion_method(std::string* existance_fusion_method) {
  ...
  _impl_.existance_fusion_method_.SetAllocated(existance_fusion_method, GetArenaForAllocation());
