...
class DstExistanceFusionConfig final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:apollo.perception.DstExistanceFusionConfig) */ {
 public:
  inline DstExistanceFusionConfig() : DstExistanceFusionConfig(nullptr) {}
  ~DstExistanceFusionConfig() override;
  explicit PROTOBUF_CONSTEXPR DstExistanceFusionConfig(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void UnsafeArenaSwap(DstExistanceFusionConfig* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  DstExistanceFusionConfig* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  protected:
  explicit DstExistanceFusionConfig(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
